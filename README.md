...
Playwright end-to-end test automation boilerplate, Using [Commonjs](https://requirejs.org/docs/commonjs.html), [Cucumber](https://github.com/cucumber/cucumber-js) and [Commonjs](https://nodejs.org/api/assert.html).. Clone or fork this repository.
